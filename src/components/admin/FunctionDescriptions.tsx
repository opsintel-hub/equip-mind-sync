...
const FUNCTION_DETAILS: FunctionInfo[] = [
  ...
  },
  {
    ...
    description: "ยืนยันการรับสินค้าที่จัดส่งพร้อมแจ้งปัญหา",
    details: [
      "ยืนยันรับสินค้าที่จัดส่ง",
      "แจ้งปัญหาสินค้า (ชำรุด, ไม่ครบ, ผิดรุ่น ฯลฯ)",
      "อัพโหลดรูปภาพ/วิดีโอเป็นหลักฐาน",
      "ดูประวัติการยืนยันรับ"
    ],
    relatedPages: ["ยืนยันรับสินค้า"]
  },
  {
    ...
    description: "อนุมัติคำขอเบิกสินค้าที่เป็นทรัพย์สิน (เฉพาะ Manager ฝ่ายนั้น)",
    details: [
      "ดูคำขอเบิกทรัพย์สินที่รออนุมัติ (เฉพาะฝ่ายที่รับผิดชอบ)",
      "อนุมัติ/ปฏิเสธคำขอเบิก",
      "ดูประวัติการอนุมัติ",
      "กรองตามฝ่าย บริษัท สถานะ ช่วงวันที่"
    ],

      ...
      content: (
        <div className="space-y-4">
          {[
            ...
            { title: "13.2 ค้นหาเอกสาร (Document Search)", desc: "ค้นหาเอกสารทุกประเภท (รับเข้า PD / เบิกจ่าย GI / ส่งตรง DS / ของเสีย DR) ตามเลขเอกสาร, ชื่อสินค้า, ช่วงวันที่ ดูรายละเอียดเอกสารและรายการสินค้าในเอกสาร" },
            { title: "13.3 Stock Movement Log", desc: "ประวัติความเคลื่อนไหวสต็อกทั้งหมด แสดงแบบ Master-Detail จัดกลุ่มตามเลขเอกสาร รองรับ 7 ประเภท: รับเข้า (receive), จ่ายออก (issue), โอนเข้า (transfer_in), โอนออก (transfer_out), ติดตั้งป้าย (install_to_billboard), ถอดจากป้าย (return_from_billboard), นำของเสียเข้า (defective_return) พร้อมตัวกรองขั้นสูง: ประเภท, ฝ่าย (Multi-select), บริษัท, ช่วงวันที่ และ Pagination — กด 'View Document' เพื่อดูรายการสินค้าทั้งหมดในเอกสารพร้อมสต็อกก่อน/หลังและสภาพสินค้า" },
            { title: "13.4 Stock Card (บัตรสต็อก)", desc: "ติดตาม 'ประวัติชีวิต' ของสินค้ารายชิ้น — แบ่ง 2 โหมด: (1) สินค้ามี S/N: ติดตามแบบ Granular พร้อม Billboard Journey แสดงประวัติติดตั้ง/ถอดจากป้ายทุกจุดพร้อมระยะเวลา (จำนวนวัน) (2) สินค้าไม่มี S/N: ติดตามยอดรวม (Aggregate) Timeline แสดงคอลัมน์ 'ป้ายโฆษณา' แยกชัดเจนว่าอุปกรณ์เคยไปติดตั้งที่จุดไหนมาบ้าง รองรับ Export Excel (3 แผ่นงาน: ข้อมูลสินค้า, Timeline, ประวัติที่ป้าย) และ PDF (A4 Landscape) เพื่อเป็นหลักฐานตรวจสอบวงจรชีวิตสินทรัพย์" },
            ...
            { title: "13.9 QR Code อุปกรณ์", desc: "สร้างและพิมพ์ QR Code สำหรับอุปกรณ์/ป้ายโฆษณา เพื่อใช้สแกนดูข้อมูลรายละเอียดสินค้าได้ทันทีผ่านมือถือ รองรับการเลือกอุปกรณ์หลายรายการพร้อมพิมพ์ QR เป็นชุด" },
            { title: "13.10 ประวัติการโอนย้าย (Transfer History)", desc: "แสดงประวัติการโอนย้ายสินค้าระหว่างสถานที่จัดเก็บทั้งหมด พร้อมข้อมูลต้นทาง-ปลายทาง, จำนวนที่โอน, วันที่โอน, ผู้ดำเนินการ กรองตามสินค้า/ช่วงเวลาได้" },
          ].map((item, i) => (
            <div key={i} className="p-3 border rounded-lg">

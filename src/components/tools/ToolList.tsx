...
import { RefreshCw, Search, Trash2, Pencil, Wrench } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-64">
              ...
              <Input
                placeholder="ค้นหารหัส, ชื่อ, Serial..."
                value={searchTerm}
        ...
        <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                คุณต้องการลบเครื่องมือนี้หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
